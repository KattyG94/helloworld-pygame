...
class SplashScreen:
    ...
    def start(self):
        ...
        _font = pygame.font.SysFont('Comic Sans MS',20)
        ...
        robot = pygame.image.load('./images/bender.jpg')
        ...
        while self.intro:
            ...
            screen.fill((41, 225, 36))
            self.ut.drawText(screen, 'Grupo de Investigación en Inteligencia Artificial y Tecnologías de Asistencia', (10,10,200), ((width/2)-100, 20, 500, 50), _font)

            self.ut.drawText(screen, 'Inteligencia Artificial 1 - Algoritmos de búsqueda', (100,20,200), ((width/2)-100, 73, 500, 100), _font)
            
            self.ut.drawText(screen, 'Universidad Politécnica Salesiana', (100,30,200), ((width/2)-100, 100, 500, 150), _font)
            
            self.ut.drawText(screen, 'Katherine González', (100,40,200), ((width/2)-100, 130, 500, 200), _font)
            
            screen.blit(giiata_logo,(10,10))
            
            #for i in range(len(points)):
                #screen.fill((255,255,255))
            screen.fill((41, 225, 36),rectc)
            x = int(points[i])*10
